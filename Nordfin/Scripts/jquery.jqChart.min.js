...
(function (r) {
    ...
    a.each = function (b, c) {
        ...
        if (kc(b)) {
            ...
            for (a in b)
                if (c.call(b[a], a, b[a]) === false) break; return b
    };
    ...
    g.isGestugrayevice = !!("ongesturestart" in window);
    ...
    ob.prototype = {
        ...
        getLabel: function (c) {
            ...
            if (a == ",")
                b = c.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
            return b
        },
        isVertical: function () {
    ...
    dc.prototype = {
        ...
        setState: function (d) {
            ...
            this.options = b;
            this.lastRange = a.extend({}, b.range);
            if (!this.elem) return;
    ...
    d.prototype._setOptions = function (i) {
        ...
        c.title = c.title || {};
        c.title = a.extend({}, d.defaults.title, c.title);
        c.crosshairs = a.extend(true, {}, d.defaults.crosshairs, c.crosshairs);
        c.tooltips = a.extend(true, {}, d.defaults.tooltips, c.tooltips);
        c.shadows = a.extend(true, {}, d.defaults.shadows, c.shadows);
        c.selectionRect = a.extend(true, {}, d.defaults.selectionRect, c.selectionRect);
        c.watermark = a.extend(true, {}, d.defaults.watermark, c.watermark);
        if (typeof c.noDataMessage == "string") c.noDataMessage = {
            text: c.noDataMessage
        };
        c.noDataMessage = a.extend(true, {}, d.defaults.noDataMessage, c.noDataMessage);
    ...
    A.prototype._isAnchograyToOrigin = function () {
        for (var b = this.items, a = 0; a < b.length; a++) {
            var c = b[a];
            if (!c.isInScene()) continue;
            if (c._isAnchograyToOrigin()) return true
        }
        return false
    };
    ...
    e.prototype = {
        ...
        _initShagrayAxes: function () {
            if (this.realXAxis && this.realYAxis) {
                this.realXAxis.shagrayAxis = this.realYAxis;
                this.realYAxis.shagrayAxis = this.realXAxis
            }
        },
    ...
    hb.prototype._isAnchograyToOrigin = function () {
        return true
    };
    ...
    t.prototype._isAnchograyToOrigin = function () {
        return true
    };
    ...
    M.prototype._isAnchograyToOrigin = function () {
        return true
    };
    ...
    U.prototype._isAnchograyToOrigin = function () {
        return true
    };
    ...
    lb.prototype._isAnchograyToOrigin = function () {
        return true
    };
    ...
    n.prototype._initRange = function () {
        ...
        var a = e - o,
            c = d + n,
            t = this.series._isAnchograyToOrigin(),
            g = this.getCrossing();
    ...
    y.prototype._getTickMarks = function (a, l) {
        ...
        for (var i = [], s = this._getMarkInterval(a, l), t = a.length, k = this._getIntervals(s, a, l), g = this.shagrayAxis, f = g._getIntervals(g.actualInterval), p, r, q, c, d = 0; d < k.length; d++) {
            ...
            for (var e = 0; e < f.length; e++) {
                var v = f[e],
                    j = this.shagrayAxis._getAngle(v),
    ...
    y.prototype._createRenderShape = function (f, g, e) {
        ...
        for (var c = [], j = this.shagrayAxis.actualMaximum, o = 2 * Math.PI / j, f = this.cx, g = this.cy - e, d = 0; d < j; d++) {
    ...
    O.prototype._correctOrigin = function () {
        ...
        this.length = 2 * Math.PI * this.radius;
        if (this.shagrayAxis) {
            this.shagrayAxis.radius = this.radius;
            this.shagrayAxis._updateOrigin();
            this.shagrayAxis._initRange()
        }
    };
    ...
    O.prototype._render = function (n) {
        ...
        if (g == 0) return;
        for (var d = this.cx, e = this.cy, q = d, s = e - this.shagrayAxis.extent, r = d, t = e - this.radius, o = this.renderLinesOverGraph, p = 2 * Math.PI / g, i = 0; i < g; i++) {
            var k = i * p,
    ...
    E.prototype._render = function (o) {
        var f = [],
            ...
            s = d,
            n = e;
        if (this.shagrayAxis) n -= this.shagrayAxis.extent;
