    ...
    if ($("#NordfinContentHolder_btnInvoiceData").hasClass("buttonDefault"))
    {
        ...
        $scope.MapRegionSweden = function (CustomerRegion) {
           ...
           SwedenRegion.push({ title: 'SE-Z', name: 'Jämtland' });
            ...
            var gaugeCount = 110;
            for (var k = 0; k < SwedenRegion.length; k++) {


                var Values = CustomerRegion.filter(function (e) {
                    return e.name == SwedenRegion[k].name;
                });

                if (Values.length > 0) {
                    ResultRegion[SwedenRegion[k].title] = { id: SwedenRegion[k].title, title: Values[0].name + '<br/>' + '<b>Customers:</b>' + Values[0].total, gaugeValue: gaugeCount };
                    gaugeCount = gaugeCount - 5;
                }
                else {
                    ResultRegion[SwedenRegion[k].title] = { id: SwedenRegion[k].title, title: SwedenRegion[k].name, gaugeValue: 0 };
                }
            ...
            $("#mapsvgSweden").mapSvg({
                ...
                colors: {
                    ...
                    'SE-AB': {
                        id: "SE-AB", 'id_no_spaces': "SE-AB", title: ResultRegion['SE-AB'].title,
                        fill: ResultRegion['SE-AB'].fill, data: {}, gaugeValue: ResultRegion['SE-AB'].gaugeValue
                    },
                    'SE-AC': {
                        id: "SE-AC", 'id_no_spaces': "SE-AC", title: ResultRegion['SE-AC'].title,
                        fill: ResultRegion['SE-AC'].fill, data: {}, gaugeValue: ResultRegion['SE-AC'].gaugeValue
                    },
                    'SE-BD': {
                        id: "SE-BD", 'id_no_spaces': "SE-BD", title: ResultRegion['SE-BD'].title,
                        fill: ResultRegion['SE-BD'].fill, data: {}, gaugeValue: ResultRegion['SE-BD'].gaugeValue
                    },

                    'SE-C': {
                        id: "SE-C", 'id_no_spaces': "SE-C", title: ResultRegion['SE-C'].title,
                        fill: ResultRegion['SE-C'].fill, data: {}, gaugeValue: ResultRegion['SE-C'].gaugeValue
                    },
                    'SE-D': {
                        id: "SE-D", 'id_no_spaces': "SE-D", title: ResultRegion['SE-D'].title,
                        fill: ResultRegion['SE-D'].fill, data: {}, gaugeValue: ResultRegion['SE-D'].gaugeValue
                    },
                    'SE-E': {
                        id: "SE-E", 'id_no_spaces': "SE-E", title: ResultRegion['SE-E'].title,
                        fill: ResultRegion['SE-E'].fill, data: {}, gaugeValue: ResultRegion['SE-E'].gaugeValue
                    },
                    'SE-F': {
                        id: "SE-F", 'id_no_spaces': "SE-F", title: ResultRegion['SE-F'].title,
                        fill: ResultRegion['SE-F'].fill, data: {}, gaugeValue: ResultRegion['SE-F'].gaugeValue
                    },
                    'SE-G': {
                        id: "SE-G", 'id_no_spaces': "SE-G", title: ResultRegion['SE-G'].title,
                        fill: ResultRegion['SE-G'].fill, data: {}, gaugeValue: ResultRegion['SE-G'].gaugeValue
                    },
                    'SE-H': {
                        id: "SE-H", 'id_no_spaces': "SE-H", title: ResultRegion['SE-H'].title,
                        fill: ResultRegion['SE-H'].fill, data: {}, gaugeValue: ResultRegion['SE-H'].gaugeValue
                    },
                    'SE-I': {
                        id: "SE-I", 'id_no_spaces': "SE-I", title: ResultRegion['SE-I'].title,
                        fill: ResultRegion['SE-I'].fill, data: {}, gaugeValue: ResultRegion['SE-I'].gaugeValue
                    },
                    'SE-K': {
                        id: "SE-K", 'id_no_spaces': "SE-K", title: ResultRegion['SE-K'].title,
                        fill: ResultRegion['SE-K'].fill, data: {}, gaugeValue: ResultRegion['SE-K'].gaugeValue
                    },
                    'SE-M': {
                        id: "SE-M", 'id_no_spaces': "SE-M", title: ResultRegion['SE-M'].title,
                        fill: ResultRegion['SE-M'].fill, data: {}, gaugeValue: ResultRegion['SE-M'].gaugeValue
                    },
                    'SE-N': {
                        id: "SE-N", 'id_no_spaces': "SE-N", title: ResultRegion['SE-N'].title,
                        fill: ResultRegion['SE-N'].fill, data: {}, gaugeValue: ResultRegion['SE-N'].gaugeValue
                    },
                    'SE-O': {
                        id: "SE-O", 'id_no_spaces': "SE-O", title: ResultRegion['SE-O'].title,
                        fill: ResultRegion['SE-O'].fill, data: {}, gaugeValue: ResultRegion['SE-O'].gaugeValue
                    },
                    'SE-S': {
                        id: "SE-S", 'id_no_spaces': "SE-S", title: ResultRegion['SE-S'].title,
                        fill: ResultRegion['SE-S'].fill, data: {}, gaugeValue: ResultRegion['SE-S'].gaugeValue
                    },
                    'SE-T': {
                        id: "SE-T", 'id_no_spaces': "SE-T", title: ResultRegion['SE-T'].title,
                        fill: ResultRegion['SE-T'].fill, data: {}, gaugeValue: ResultRegion['SE-T'].gaugeValue
                    },
                    'SE-U': {
                        id: "SE-U", 'id_no_spaces': "SE-U", title: ResultRegion['SE-U'].title,
                        fill: ResultRegion['SE-U'].fill, data: {}, gaugeValue: ResultRegion['SE-U'].gaugeValue
                    },
                    'SE-W': {
                        id: "SE-W", 'id_no_spaces': "SE-W", title: ResultRegion['SE-W'].title,
                        fill: ResultRegion['SE-W'].fill, data: {}, gaugeValue: ResultRegion['SE-W'].gaugeValue
                    },
                    'SE-X': {
                        id: "SE-X", 'id_no_spaces': "SE-X", title: ResultRegion['SE-X'].title,
                        fill: ResultRegion['SE-X'].fill, data: {}, gaugeValue: ResultRegion['SE-X'].gaugeValue
                    },
                    'SE-Y': {
                        id: "SE-Y", 'id_no_spaces': "SE-Y", title: ResultRegion['SE-Y'].title,
                        fill: ResultRegion['SE-Y'].fill, data: {}, gaugeValue: ResultRegion['SE-Y'].gaugeValue
                    },
                    'SE-Z': {
                        id: "SE-Z", 'id_no_spaces': "SE-Z", title: ResultRegion['SE-Z'].title,
                        fill: ResultRegion['SE-Z'].fill, data: {}, gaugeValue: ResultRegion['SE-Z'].gaugeValue
                    },
        ...
        $scope.MapRegionFinland = function (CustomerRegion) {
            ...
            var gaugeCount = 100;
            for (var k = 0; k < FinlandRegion.length; k++) {


                var Values = CustomerRegion.filter(function (e) {
                    return e.name == FinlandRegion[k].name;
                });

                if (Values.length > 0) {
                    ResultRegion[FinlandRegion[k].title] = { id: FinlandRegion[k].title, title: Values[0].name + '<br/>' + '<b>Customers:</b>' + Values[0].total, gaugeValue: gaugeCount };
                    gaugeCount = gaugeCount - 5;
                }
                else {
                    ResultRegion[FinlandRegion[k].title] = { id: FinlandRegion[k].title, title: FinlandRegion[k].name , gaugeValue: 0 };
                }
            ...
            $("#mapsvgFinland").mapSvg({
                width: 387.89114, height: 787, lockAspectRatio: false, colors:
                {
                    ...
                    'FI-01': {
                        id: "FI-01", 'id_no_spaces': "FI-01", title: ResultRegion['FI-01'].title,
                        fill: ResultRegion['FI-01'].fill, data: {}, gaugeValue: ResultRegion['FI-01'].gaugeValue
                    },
                    'FI-02': {
                        id: "FI-02", 'id_no_spaces': "FI-02", title: ResultRegion['FI-02'].title,
                        fill: ResultRegion['FI-02'].fill, data: {}, gaugeValue:  ResultRegion['FI-02'].gaugeValue
                    },
                    'FI-03': {
                        id: "FI-03", 'id_no_spaces': "FI-03", title: ResultRegion['FI-03'].title,
                        fill: ResultRegion['FI-03'].fill, data: {}, gaugeValue:  ResultRegion['FI-03'].gaugeValue
                    },

                    'FI-04': {
                        id: "FI-04", 'id_no_spaces': "FI-04", title: ResultRegion['FI-04'].title,
                        fill: ResultRegion['FI-04'].fill, data: {}, gaugeValue: ResultRegion['FI-04'].gaugeValue
                    },
                    'FI-05': {
                        id: "FI-05", 'id_no_spaces': "FI-05", title: ResultRegion['FI-05'].title,
                        fill: ResultRegion['FI-05'].fill, data: {}, gaugeValue:  ResultRegion['FI-05'].gaugeValue
                    },
                    'FI-06': {
                        id: "FI-06", 'id_no_spaces': "FI-06", title: ResultRegion['FI-06'].title,
                        fill: ResultRegion['FI-06'].fill, data: {}, gaugeValue: ResultRegion['FI-06'].gaugeValue
                    },
                    'FI-07': {
                        id: "FI-07", 'id_no_spaces': "FI-07", title: ResultRegion['FI-07'].title,
                        fill: ResultRegion['FI-07'].fill, data: {}, gaugeValue: ResultRegion['FI-07'].gaugeValue
                    },
                    'FI-08': {
                        id: "FI-08", 'id_no_spaces': "FI-08", title: ResultRegion['FI-08'].title,
                        fill: ResultRegion['FI-08'].fill, data: {}, gaugeValue: ResultRegion['FI-08'].gaugeValue
                    },
                    'FI-09': {
                        id: "FI-09", 'id_no_spaces': "FI-09", title: ResultRegion['FI-09'].title,
                        fill: ResultRegion['FI-09'].fill, data: {}, gaugeValue: ResultRegion['FI-09'].gaugeValue
                    },
                    'FI-10': {
                        id: "FI-10", 'id_no_spaces': "FI-10", title: ResultRegion['FI-10'].title,
                        fill: ResultRegion['FI-10'].fill, data: {}, gaugeValue: ResultRegion['FI-10'].gaugeValue
                    },
                    'FI-11': {
                        id: "FI-11", 'id_no_spaces': "FI-11", title: ResultRegion['FI-11'].title,
                        fill: ResultRegion['FI-11'].fill, data: {}, gaugeValue: ResultRegion['FI-11'].gaugeValue
                    },
                    'FI-12': {
                        id: "FI-12", 'id_no_spaces': "FI-12", title: ResultRegion['FI-12'].title,
                        fill: ResultRegion['FI-12'].fill, data: {}, gaugeValue: ResultRegion['FI-12'].gaugeValue
                    },
                    'FI-13': {
                        id: "FI-13", 'id_no_spaces': "FI-13", title: ResultRegion['FI-13'].title,
                        fill: ResultRegion['FI-13'].fill, data: {}, gaugeValue: ResultRegion['FI-13'].gaugeValue
                    },
                    'FI-14': {
                        id: "FI-14", 'id_no_spaces': "FI-14", title: ResultRegion['FI-14'].title,
                        fill: ResultRegion['FI-14'].fill, data: {}, gaugeValue: ResultRegion['FI-14'].gaugeValue
                    },
                    'FI-15': {
                        id: "FI-15", 'id_no_spaces': "FI-15", title: ResultRegion['FI-15'].title,
                        fill: ResultRegion['FI-15'].fill, data: {},gaugeValue: ResultRegion['FI-15'].gaugeValue
                    },
                    'FI-16': {
                        id: "FI-16", 'id_no_spaces': "FI-16", title: ResultRegion['FI-16'].title,
                        fill: ResultRegion['FI-16'].fill, data: {}, gaugeValue: ResultRegion['FI-16'].gaugeValue
                    },
                    'FI-17': {
                        id: "FI-17", 'id_no_spaces': "FI-17", title: ResultRegion['FI-17'].title,
                        fill: ResultRegion['FI-17'].fill, data: {}, gaugeValue: ResultRegion['FI-17'].gaugeValue
                    },
                    'FI-18': {
                        id: "FI-18", 'id_no_spaces': "FI-18", title: ResultRegion['FI-18'].title,
                        fill: ResultRegion['FI-18'].fill, data: {}, gaugeValue: ResultRegion['FI-18'].gaugeValue
                    },
                    'FI-19': {
                        id: "FI-19", 'id_no_spaces': "FI-19", title: ResultRegion['FI-19'].title,
                        fill: ResultRegion['FI-19'].fill, data: {},gaugeValue: ResultRegion['FI-19'].gaugeValue
                    },
