<%@ Page Language="C#" MasterPageFile="~/Nordfin.Master" AutoEventWireup="true" Title="NordfinCapital" EnableEventValidation="true" CodeBehind="frmCustomer.aspx.cs" Inherits="Nordfin.frmCustomer"  UICulture="sv-SE" Culture="sv-SE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="NordfinContentHolder" runat="server" style="background-color: #232D41;">
    ...
    <div class="modal fade" id="mdlExportDetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
